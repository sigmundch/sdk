...
abstract class MemoryModularStep extends ModularStep {
  Future<Map<DataId, Object>> execute(Module module, SourceProvider sourceProvider,
...
class MemoryPipeline extends Pipeline<MemoryModularStep> {
  ...
  Future<void> runStep(MemoryModularStep step, Module module,
    ...
    Map<DataId, Object> result = await step.execute(module, (Uri uri) =>
        inputSources[uri], (Module m, DataId id) => inputData[m][id]);
